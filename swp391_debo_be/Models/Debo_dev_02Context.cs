...
public partial class Debo_dev_02Context : DbContext
{
    public Debo_dev_02Context(DbContextOptions<Debo_dev_02Context> options)
        : base(options)
    {
    }
    ...
    protected override void OnModelCreating(ModelBuilder modelBuilder)
    {
        ...
        modelBuilder.Entity<Booking>(entity =>
        {
            ...
            entity.HasIndex(e => e.PaymentId, "UQ__Booking__DA6C7FE003D3E611").IsUnique();
        ...
        modelBuilder.Entity<Manager>(entity =>
        {
            ...
            entity.HasIndex(e => e.BrId, "UQ_Manager_Br_ID").IsUnique();
